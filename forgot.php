	...
	<body>
		...
		<section id="content">
		 ...
		 <br>
			...
			<form action="forgotPasswordAction.php" name="form" method="post">
			<fieldset>
				<div class="coll-1">
				  <div>
				  <h4>
				  ...
				  <div>
				  <h4>
					<div class="form-txt">Enter The New Password:</div>
					<input type ="password" name="verifyPass1" size="25" maxlength="15" placeholder="Password">
					<div class="clear"></div>
					&nbsp;
				  </h4>
				  </div>
				  <div>
				  <h4>
					<div class="form-txt">Re-Enter The New Password:</div>
					<input type ="password" name="verifyPass2" size="25" maxlength="15" placeholder="Password">
					<div class="clear"></div>
					&nbsp;
				  </h4>
				  </div>
